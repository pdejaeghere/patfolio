---
layout: math
title: Jeudi – Fonctions et dérivées
...
4. Calculer : $$(x^2)'$$  
5. Calculer : $$(x^3)'$$  
6. Calculer : $$(2x^2 - 3x + 1)'$$  

---

## 3️⃣ Tableau de variations
7. Pour $$f(x) = x^2 - 4x + 3$$, trouver les extremums et dresser un **tableau de variation**  

---

## 4️⃣ Petit challenge
8. Étudier : $$f(x) = x^3 - 3x^2 + 2$$  
- Dérivée  
- Extremums  
