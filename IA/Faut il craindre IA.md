...
Alors, oui, utilisons l'IA, comme on utilise le web pour rechercher une solution à un problème déjà rencontré, mais ne perdons pas le goût de l'effort, ne soyons pas fier d'avoir fait travailler l'IA à notre place. Courrir 5, 10, 20, 40 km, ça demande un effort et cet effort, dans le sport, est une source de plaisir, de satisfaction, même si ce n'est pas simple de s'y mettre ou remettre (le sport n'est qu'un exemple).
